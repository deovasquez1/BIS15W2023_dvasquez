...
```
## # A tibble: 3 × 3
##   class    longevity_mean n_amniotes
##   <chr>             <dbl>      <int>
## 1 Aves              -826.       9802
## 2 Mammalia          -465.       4953
## 3 Reptilia          -812.       6567
...
```
## # A tibble: 3 × 3
##   order       longevity_mean n_amphibians
##   <chr>                <dbl>        <int>
## 1 Anura                 9.12         5971
## 2 Caudata              16.1           619
## 3 Gymnophiona           8.25          186
```
...
The authors did intend to leave NA in each of these variables because the species could have overlap and be fossorial and terrestrial at the same time. However, they could also represent a mistake or unknown data because some species do have NA for all four variables. 
