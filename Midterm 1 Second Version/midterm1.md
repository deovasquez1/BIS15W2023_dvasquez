---
title: "Midterm 1, Second Version"
author: "Deon Vasquez"
date: "2023-01-31"
output:
  html_document: 
...
## 5 Resident                     4.03
```
Ducks that migrate long distances have a low average body mass.
...
```
## # A tibble: 7 × 6
##   habitat   mean_mass sd_mass max_mass min_mass n_birds
##   <chr>         <dbl>   <dbl>    <dbl>    <dbl>   <int>
## 1 Grassland      2.07   0.709     3.36     1.11      36
## 2 Ocean          2.72   0.484     3.54     1.63      44
## 3 Shrubland      1.59   0.591     3.28     0.48      82
## 4 Various        1.84   0.808     3.93     0.7       45
## 5 Wetland        2.56   0.668     4.04     0.96     153
## 6 Woodland       1.60   0.642     3.76     0.48     177
## 7 <NA>           1.96   0.374     2.5      1.33      14
```
What is the distribution of bird masses across all habitats?
...
```r
person_i_worked_with <- c("Ben Ramirez")
person_i_worked_with
```
