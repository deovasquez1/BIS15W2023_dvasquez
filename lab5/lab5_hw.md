...
##  3 Abraxas    Male   blue    Cosm… Black       NA Marvel… <NA>    bad         NA
##  4 Adam Monr… Male   blue    <NA>  Blond       NA NBC - … <NA>    good        NA
##  5 Agent 13   Female blue    <NA>  Blond      173 Marvel… <NA>    good        61
##  6 Agent Zero Male   <NA>    <NA>  <NA>       191 Marvel… <NA>    good       104
##  7 Air-Walker Male   blue    <NA>  White      188 Marvel… <NA>    bad        108
##  8 Ajax       Male   brown   Cybo… Black      193 Marvel… <NA>    bad         90
##  9 Alan Scott Male   blue    <NA>  Blond      180 DC Com… <NA>    good        90
## 10 Alex Wool… Male   <NA>    <NA>  <NA>        NA NBC - … <NA>    good        NA
## # … with 494 more rows, and abbreviated variable names ¹​eye_color, ²​hair_color,
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```
...
## # … with 724 more rows, 1 more variable: height_to_weight_ratio <dbl>, and
